...
"""
    ...
    def eval(self, script, context=None, input_file=None):
...
def func_nfc(parser, text):
    return unicodedata.normalize("NFC", text)

def func_nfd(parser, text):
...
register_script_function(func_nfc, "nfc")
register_script_function(func_nfd, "nfd")
